...
**[TechnoRAG](https://github.com/GSatya147/TechnoRAG)**
11-stage hybrid retrieval pipeline for tech-news intelligence. Hybrid search, temporal reasoning, faithfulness verification, prompt-cache optimized.

`FastAPI` `LangFuse` `Streamlit`
...
**[Multi-Agentic Pipeline](https://github.com/GSatya147/Multi-agentic-pipeline)**
Supervisor/researcher/writer multi-agent system with custom MCP server, HITL checkpoints at critical nodes.
